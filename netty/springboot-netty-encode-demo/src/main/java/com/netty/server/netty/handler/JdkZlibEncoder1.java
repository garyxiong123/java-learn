 ...
 */
public class JdkZlibEncoder1 extends JdkZlibEncoder {
     ...
     * @throws CompressionException if failed to initialize zlib
     */
    public JdkZlibEncoder1(int compressionLevel) {
     ...
     * @throws CompressionException if failed to initialize zlib
     */
    public JdkZlibEncoder1(ZlibWrapper wrapper) {
        this(wrapper, 6);
    }
     ...
     * @throws CompressionException if failed to initialize zlib
     */
    public JdkZlibEncoder1(ZlibWrapper wrapper, int compressionLevel) {
     ...
     * @throws CompressionException if failed to initialize zlib
     */
    public JdkZlibEncoder1(byte[] dictionary) {
        this(6, dictionary);
    }
     ...
     * @throws CompressionException if failed to initialize zlib
     */
    public JdkZlibEncoder1(int compressionLevel, byte[] dictionary) {
        if (compressionLevel < 0 || compressionLevel > 9) {
            throw new IllegalArgumentException(
                    "compressionLevel: " + compressionLevel + " (expected: 0-9)");
        }
